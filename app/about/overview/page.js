          ...
          <div className="container mx-auto px-5 sm:px-6 max-w-[1366px]">
            <div className="flex flex-col items-center text-center space-y-6 md:space-y-8">
              <h2 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-normal tracking-tight md:tracking-wide leading-tight text-slate-900 max-w-5xl">
                Optimizing Revenues.{" "}
                <span className="text-[#B98C29]">Empowering Care.</span>
              </h2>
              ...
              <div className="space-y-6 w-full">
                <p className="max-w-3xl mx-auto text-base md:text-lg leading-relaxed font-normal text-slate-600">
                  ...
                  Revenue Cycle Management process effectively.
                </p>
                <p className="max-w-3xl mx-auto text-base md:text-lg leading-relaxed font-normal text-slate-600">
                  We strive to help healthcare providers surmount the
                  complexities of medical billing. Doing so will help us amplify
                  the focus healthcare providers have on patient care.
                </p>
                ...
                <div className="max-w-3xl mx-auto text-left mt-12 space-y-10">
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-600 leading-relaxed text-base md:text-lg">
                      Centum RCM aims to empower US healthcare providers with
                      secure, compliant, and technology driven revenue cycle
                      solutions. Our aim is to help you focus on exceptional
                      patient care while we accelerate collections, reduce
                      denials & shorten the accounts receivable days.
                    </p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-slate-600 leading-relaxed text-base md:text-lg">
                      ...
                      accelerating cash flow. We would constantly optimize the
                      revenue cycle through precision, technology, and
                      compliance.
                    </p>
                  </div>
                </div>
