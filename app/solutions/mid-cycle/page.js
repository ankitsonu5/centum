      ...
      <main className="flex-1 overflow-x-hidden">
        ...
        <section className="py-20 lg:py-28 bg-[#f8fafc] border-y border-slate-100">
          <div className="container mx-auto px-6 max-w-7xl">
            {/* Header Block on Top */}
            <div className="flex flex-col md:flex-row justify-start items-center mb-14 gap-12 lg:gap-24 text-left">
              ...
              <div className="max-w-md space-y-4">
                <p className="text-lg lg:text-xl text-zinc-600 font-normal leading-relaxed text-left">
                  Centum RCM translates clinical activity into billable revenue with high precision. This stage is most important as errors lead to claim denials and revenue leakage. We convert clinical documentation into standardised codes that are used by insurance companies to determine reimbursements.
                </p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 text-left">
              ...
              <div className="lg:col-span-2 bg-[#0a192f] text-white p-10 lg:p-14 rounded-[2.5rem] flex flex-col justify-center group transition-transform duration-500 hover:-translate-y-1">
                ...
                <p className="text-lg lg:text-xl text-white/90 leading-relaxed lg:max-w-4xl font-normal">
              ...
              <div className="bg-[#f0f0f0] p-10 lg:p-12 rounded-[2.5rem] flex flex-col group transition-transform duration-500 hover:-translate-y-1">
                ...
                <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed mt-auto font-normal">
                  We can also help healthcare providers set up and implement speciality-specific EHR Templates. This helps improve workflow efficiency, reduces documentation errors, makes coding dependable thereby reducing claim denials.
                </p>
              </div>

              {/* Card 4: 04 (Span 2, Light Wide) */}
              <div className="lg:col-span-2 bg-[#f0f0f0] p-10 lg:p-12 rounded-[2.5rem] flex flex-col md:flex-row gap-4 lg:gap-8 items-start md:items-center group transition-transform duration-500 hover:-translate-y-1">
                <div className="md:w-1/4">
                  <h3 className="text-6xl lg:text-7xl font-normal text-[#1a1a1a] leading-none">04</h3>
                </div>
                <div className="md:w-3/4">
                  <h4 className="text-3xl font-normal text-[#1a1a1a] mb-4">Compliance and Auditing</h4>
                  <p className="text-lg lg:text-xl text-zinc-600 leading-relaxed font-normal">
