      ...
      <main className="flex-1">
        ...
        <section className="relative h-[100vh] flex items-end justify-center overflow-hidden bg-hero-bg pb-6 sm:pb-12">
          ...
          <div className="relative container mx-auto px-6 text-center max-w-7xl z-20 pt-40 md:pt-60 flex flex-col items-center">
            ...
            <h1 className="w-full max-w-[1120px] text-4xl sm:text-6xl lg:text-[3.5rem] xl:text-[4.2rem] 2xl:text-[5rem] text-white mb-6 leading-[1.08] uppercase flex flex-col items-center text-center">
              <span className="font-bold text-[0.81em]">
                Precision Billing.
              </span>
              <span className="font-bold text-[0.84em] text-transparent bg-clip-text bg-gradient-to-r from-[#f0da9b] via-[#e5ca78] to-[#B98C29] tracking-[0.04em]">
                Proven Results.
              </span>
            </h1>
          </div>
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="flex flex-col lg:flex-row justify-between items-start lg:items-end mb-12 lg:mb-16 gap-8">
              <div className="text-left max-w-2xl">
                <span className="text-[#B98C29] uppercase tracking-widest text-base md:text-lg font-bold block mb-4">
                  About Us
                </span>
                <h2 className="text-3xl md:text-4xl lg:text-5xl text-[#243B71] leading-tight mb-6">
                  Optimizing Revenues. <br className="hidden md:block" />
                  Empowering Care.
                </h2>
                <p className="text-slate-600 text-lg leading-relaxed">
                  Centum RCM is your end-to-end partner in administering the
                  Revenue Cycle Management process effectively. We strive to
                  help healthcare providers surmount the complexities of medical
                  billing, thereby amplifying focus on patient care.
                </p>
              </div>
              <Link
                href="/about/overview"
                className="inline-flex text-[#243B71] font-bold text-base md:text-lg tracking-wide items-center gap-2 lg:mb-2 group transition-all"
              >
                Read More About Us{" "}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 lg:gap-8">
              ...
              <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 flex flex-col justify-between group transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="space-y-4">
                    <h3 className="text-2xl md:text-3xl text-[#243B71] tracking-tight">
                      Vision & Mission
                    </h3>
                    <p className="text-zinc-500 text-base md:text-lg leading-relaxed">
                      To deliver predictable financial performance for U.S.
                      healthcare providers by reducing revenue leakage &
                      accelerating cash flow through precision, technology, and
                      compliance.
                    </p>
                  </div>
                </div>
                <Link
                  href="/about/overview"
                  className="mt-10 md:mt-12 text-[#B98C29] font-bold text-sm uppercase tracking-widest flex items-center gap-2 group-hover:gap-3 transition-all"
                >
              ...
              <div className="bg-[#1e293b] text-white p-8 md:p-10 rounded-[2.5rem] flex flex-col justify-between group transition-all duration-500 hover:shadow-xl hover:-translate-y-2 relative overflow-hidden">
                <div className="relative z-10 space-y-6 md:space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-white/80 text-base md:text-lg leading-relaxed">
                      We follow strict HIPAA-compliant processes, accurate
                      coding standards, and payer guidelines ensuring zero
                      compliance risk.
                    </p>
                    <ul className="space-y-3 text-sm md:text-base text-white/70 pt-2">
                      <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 bg-[#B98C29] rounded-full"></span>{" "}
                        Legal Compliance
                      </li>
                      <li className="flex items-center gap-3">
                        <span className="w-1.5 h-1.5 bg-[#B98C29] rounded-full"></span>{" "}
                ...
                <Link
                  href="/about/practice"
                  className="relative z-10 mt-10 md:mt-12 text-[#B98C29] font-bold text-sm uppercase tracking-widest flex items-center gap-2 group-hover:gap-3 transition-all"
                >
              ...
              <div className="bg-white p-8 md:p-10 rounded-[2.5rem] border border-slate-100 flex flex-col justify-between group transition-all duration-500 hover:shadow-xl hover:-translate-y-2">
                <div className="space-y-6 md:space-y-8">
                  ...
                  <div className="space-y-4">
                    ...
                    <p className="text-zinc-500 text-base md:text-lg leading-relaxed">
                      We specialize in a wide range of EHR and PM systems. We
                      don't require you to switch systems; we integrate
                      seamlessly.
                    </p>
                    <div className="pt-2 flex flex-wrap gap-2">
                      <span className="px-3 py-1.5 bg-[#f0ede8] text-[#243B71] text-xs font-bold rounded-full uppercase tracking-wider">
                        No Learning Curve
                      </span>
                      <span className="px-3 py-1.5 bg-[#f0ede8] text-[#243B71] text-xs font-bold rounded-full uppercase tracking-wider">
                        Fast Onboarding
        ...
        <section className="relative py-24 bg-[#0a192f] text-white overflow-hidden">
          <div className="relative z-10 container mx-auto px-6 max-w-7xl text-center">
            ...
            <p className="text-sm lg:text-base text-gray-300 max-w-4xl mx-auto mb-16">
              We help you improve customer experience, accelerate revenue
              cycles, reduce denials & mitigate revenue leakage. All this while
              ensuring that your processes are strictly compliant - to current
              and as well as emerging laws.
            </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 px-4 lg:px-0">
              {[
                ...
                <Link
                  key={i}
                  href={item.href}
                  className="flex flex-col h-full bg-white rounded-lg overflow-hidden group cursor-pointer transition-all duration-300"
                >
        ...
        <section className="py-24 bg-white overflow-hidden">
          <div className="container mx-auto px-6 max-w-7xl text-center">
            <h2 className="text-4xl lg:text-5xl font-bold text-[#243B71] mb-2 tracking-tight">
              How It Works
            </h2>
            <p className="text-lg text-slate-500 italic mb-20">
              Our Proven RCM Process in{" "}
              <span className="font-bold text-[#243B71]">7 Easy Steps.</span>
            </p>
            ...
            <div className="relative flex flex-wrap lg:flex-nowrap justify-between items-start gap-y-12 lg:gap-x-2">
              {[
                ...
                <div
                  key={i}
                  className="flex flex-col items-center w-full lg:w-auto relative px-2"
                >
                  ...
                  {i < arr.length - 1 && (
                    <div className="hidden lg:block absolute top-12 left-[100%] -translate-x-1/2 z-0">
                      <svg
                        className="w-12 h-6 text-zinc-300"
                        fill="none"
                        stroke="currentColor"
                        viewBox="0 0 48 24"
                      >
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-10 pt-2">
                  <div className="space-y-4">
                    ...
                    <a
                      ...
                      className="text-lg font-medium text-[#1a1a1a] hover:text-[#B98C29] transition-colors break-words underline decoration-[#B98C29]/30 underline-offset-8"
                    >
                      team@centumrcm.com
                    </a>
                  </div>
