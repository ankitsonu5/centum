...
const getArticleData = (slug) => {
  ...
  return (
    allArticles[slug] || {
      ...
      content: [
        "The requested article could not be found. Please return to the insights page to browse our other articles.",
      ],
    }
  );
};
...
export function generateStaticParams() {
  return [
    { slug: "future-of-ai-medical-coding" },
    { slug: "navigating-payer-audits-strategies-for-100-compliance" },
    { slug: "maximizing-front-end-collections" },
  ];
}
        ...
        <article className="w-full max-w-[1366px] mx-auto px-6 lg:px-8 py-16">
          <div className="bg-white p-8 md:p-14 lg:p-20 rounded-[2rem] shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] border border-slate-100 mb-16">
            ...
            <div className="mb-12 border-b border-slate-100 pb-10 max-w-5xl mx-auto">
              <span className="text-[#B98C29] text-xs tracking-widest block font-bold mb-4 uppercase">
                {article.category}
              </span>
            ...
            <div className="max-w-5xl mx-auto">
              {article.content.map((paragraph, index) => (
                <p
                  key={index}
                  className="text-lg lg:text-xl leading-relaxed mb-8 font-normal text-slate-600"
                >
                  {paragraph}
                </p>
              ))}
            ...
            <div className="max-w-5xl mx-auto mt-16 pt-8 border-t border-slate-100 flex items-center gap-6">
              ...
              <div>
                <p className="text-xs tracking-widest text-[#B98C29] font-bold uppercase mb-1">
                  Written By
                </p>
