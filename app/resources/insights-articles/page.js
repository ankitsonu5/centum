  ...
  const articles = [
    {
      ...
      date: "Oct 24, 2025",
      excerpt: "Discover how intelligent automation is transforming mid-cycle workflows, reducing claim denials, and accelerating revenue collection without human error.",
    ...
    },
    {
      ...
      category: "Compliance",
      date: "Nov 02, 2025",
      excerpt: "A comprehensive guide to ensuring your documentation integrity stands up to rigorous payer audits and eliminates revenue leakage.",
    ...
    },
    {
      ...
      date: "Nov 15, 2025",
      excerpt: "Learn how financial transparency tools and early eligibility verification can boost your practice's upfront revenue while keeping patients happy.",
          ...
          <div className="container mx-auto px-6 max-w-7xl">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-12">
              {articles.map((article, i) => (
                <Link href={article.link} key={i} className="group bg-white rounded-[2rem] border border-slate-100 shadow-sm overflow-hidden transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_20px_40px_-15px_rgba(0,0,0,0.05)] flex flex-col cursor-pointer">
                  {/* Image Block */}
            ...
            <div className="mt-24 lg:mt-32 p-10 md:p-16 rounded-[3rem] bg-[#f8fafc] border border-slate-100 text-center relative overflow-hidden group">
               <div className="relative z-10 max-w-3xl mx-auto">
                 <div className="w-16 h-16 rounded-full bg-white shadow-sm flex items-center justify-center mx-auto mb-8 border border-slate-100">
                    <svg className="w-8 h-8 text-[#B98C29]" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                 </div>
                 <h2 className="text-3xl lg:text-5xl font-normal tracking-tight text-[#1e293b] mb-6">Stay ahead of the curve.</h2>
                 <p className="text-lg text-slate-500 font-normal mb-10 leading-relaxed">
                   Join leading healthcare executives receiving our monthly newsletter on maximizing revenue efficiency.
                 </p>
