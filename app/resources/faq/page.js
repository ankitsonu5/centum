      ...
      <main className="flex-1 w-full flex flex-col items-center">
        ...
        <div className="relative w-full h-[60vh] min-h-[450px] lg:h-[65vh] flex flex-col justify-center items-center overflow-hidden">
          ...
          <div className="relative z-10 text-center text-white px-6">
            <h1 className="text-4xl md:text-6xl font-semibold tracking-wide drop-shadow-md">
              FAQs
            </h1>
          </div>
        </div>
            ...
            <div className="space-y-6">
              {faqs.map((faq, index) => (
                ...
                >
                  ...
                  >
                    <span
                      className={`text-lg md:text-xl font-semibold transition-colors duration-300 ${openIndex === index ? "text-[#B98C29]" : "text-[#243B71] group-hover:text-[#B98C29]"}`}
                    >
                      {index + 1}. {faq.q}
                    </span>
                    <span
                      className={`flex-shrink-0 w-8 h-8 rounded-full border border-slate-200 flex items-center justify-center transition-all duration-300 ${openIndex === index ? "bg-[#B98C29] border-[#B98C29] text-white rotate-180" : "text-[#243B71]"}`}
                    >
                      <svg
                        width="12"
                        height="12"
